...
@section('content_body')
    <div class="container">        
        ...
        <p style="font-weight: bolder"><a href="{{asset('programsv4/SimHubSetup_9.4.4.exe')}}">Clique aqui para baixar o Dashboard para o SimHub</a></p>
        ...
        <img src="{{asset('images/setup_vjoy/setup_vjoy.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">next</span>:</p>
        <hr>
        <img src="{{asset('images/setup_vjoy/setup_vjoy2.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">next</span>:</p>
        <hr>
        <img src="{{asset('images/setup_vjoy/setup_vjoy3.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">OK</span>:</p>
        <hr>
        <img src="{{asset('images/setup_vjoy/setup_vjoy4.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_vjoy/setup_vjoy_configuracao_padrao.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup1.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">next</span>:</p>
        <hr>
        <img src="{{asset('images/setup_simhub/setup2.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">next</span>:</p>
        <hr>
        <img src="{{asset('images/setup_simhub/setup3.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup4.JPG')}}" alt="">

        <hr>
        <p>Depois clique em <span style="font-weight: bolder">Finish</span>:</p>
        <hr>
        <img src="{{asset('images/setup_simhub/setup5_launch.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup6.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup7.JPG')}}" alt="">

        <hr>
        <p>Procure o ETS2 e <span style="font-weight: bolder">clique nele duas vezes</span>:</p>
        <hr>
        <img src="{{asset('images/setup_simhub/setup8.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup9.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup10.JPG')}}" alt="">

        <hr>
        <p>Depois clique <em></em><span style="font-weight: bolder">OK</span>:</p>
        <hr>
        <img src="{{asset('images/setup_simhub/setup11.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup12.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup13.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_simhub/setup14.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_ets2controller/config_ets2.JPG')}}" alt="">        

        <hr>
        <h4>Toda vez que for jogar, abra o executável <span style="font-weight: bolder">ets2controller.exe</span>:</h4>
        <hr>
        <img id="img" src="{{asset('images/setup_ets2controller/config_ets2_1.JPG')}}" alt="">
        ...
        <hr>
        <img src="{{asset('images/setup_ets2controller/config_ets2_2.JPG')}}" alt="">
        ...
        <script src="{{asset('js/control_imgs.js?').config('app.app_version')}}"></script>
        @endsection
@endsection